...
import com.springboot.dubbo.demo.common.scanner.Scannable;
...
public abstract class SimpleProperty<E> implements Scannable, Serializable {
    ...
    public static <T extends SimpleProperty,E> T newInstance(Class<T> type,String group,String groupName, E code, String name,String defaultVal) {
        T instance = null;
        try {
            instance = type.newInstance();
        } catch (Exception e) {
