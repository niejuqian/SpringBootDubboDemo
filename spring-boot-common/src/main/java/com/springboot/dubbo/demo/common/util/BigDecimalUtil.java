...
public class BigDecimalUtil {
     ...
     * @return
     */
    public static BigDecimal roundHalfDown(int scale , BigDecimal bigDecimal) {
        if (null == bigDecimal) return BigDecimal.ZERO;
    ...
    public static String toStringStripTrailingZeros(BigDecimal bigDecimal){
        if (null == bigDecimal) {
            return "0";
        }
    ...
    /*public static void main(String[] args) {
        BigDecimal b = new BigDecimal("1000.00");
        System.out.println(toStringStripTrailingZeros(b));
    }*/
}
