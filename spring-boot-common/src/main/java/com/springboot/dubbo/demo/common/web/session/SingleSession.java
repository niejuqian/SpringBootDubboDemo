package com.springboot.dubbo.demo.common.web.session;

import com.springboot.dubbo.demo.common.bean.UUIDEntity;
import com.springboot.dubbo.demo.common.cache.HashCache;
import com.springboot.dubbo.demo.common.helper.CookieHelper;
import com.springboot.dubbo.demo.common.util.StringUtil;
import com.springboot.dubbo.demo.common.util.WebUtil;
import com.springboot.dubbo.demo.common.web.RequestContext;
...
public abstract class SingleSession<U extends UUIDEntity> extends HashCache implements HandlerInterceptor {
    ...
    public static String COOKIE_SESSION_ID = "SessionID_Bore";
    /**
     * 当前线程所对应的sessionId
     */
