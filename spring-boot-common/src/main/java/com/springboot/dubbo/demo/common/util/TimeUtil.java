...
public class TimeUtil {
     ...
     * 一天的秒数
     */
    public static final long ONE_DAY_SS = 24 * 60 * 60;
    ...
    public static Date convertYear(Date d, int i) {
        Date date = now();
        date.setTime((new DateTime(d)).plusYears(i).getMillis());
        return date;
    }
    ...
    public static Date convertMonth(Date d, int i) {
        Date date = now();
        date.setTime((new DateTime(d)).plusMonths(i).getMillis());
        return date;
    }
    ...
    public static Date convertDay(Date d, int i) {
        Date date = now();
        date.setTime((new DateTime(d)).plusDays(i).getMillis());
        return date;
    }
    ...
    public static Date convertHour(Date d, int i) {
        Date date = now();
        date.setTime((new DateTime(d)).plusHours(i).getMillis());
        return date;
    }
    ...
    public static Date convertMinute(Date d, int i) {
        Date date = now();
        date.setTime((new DateTime(d)).plusMinutes(i).getMillis());
        return date;
    }
    ...
    public static Date convertSecond(Date d, int i) {
        Date date = now();
        date.setTime((new DateTime(d)).plusSeconds(i).getMillis());
        return date;
    }
    ...
    public static Date convertMilliSecond(Date d, int i) {
        Date date = now();
        date.setTime((new DateTime(d)).plusMillis(i).getMillis());
        return date;
    }
    ...
    public static int getHourInteger(Date date){
        return getInteger(date,Calendar.HOUR_OF_DAY);
    }

    /*public static void main(String[] args) {
        Date date = now();
        Date preDate = convertDay(date,-1);
        System.out.println(dateTimeFormat(date));
        System.out.println(dateTimeFormat(preDate));
        String dateFmt = dateFormat(date);
        String preDateFmt = dateFormat(preDate);
        System.out.println(dateFmt);
        System.out.println(preDateFmt);
        String change = " 09:00:00";
        String dateFmtChange = dateFmt + change;
        String preDateFmtChange = preDateFmt + change;
        System.out.println(dateFmtChange);
        System.out.println(preDateFmtChange);
        Date dateFmtChangeDate = parseDatetime(dateFmtChange);
        Date preDateFmtChangeDate = parseDatetime(preDateFmtChange);
        long d1 = dateFmtChangeDate.getTime();
        long d2 = preDateFmtChangeDate.getTime();
        long diff = (d1 - d2) / 1000;
        System.out.println(d1);
        System.out.println(d2);
        System.out.println(diff);
        System.out.println(ONE_DAY_SS);
    }*/
    ...
    public static String getNextDate(){
        ...
        return dateToString(calendar.getTime(), DateStyle.YYYYMMDD);
    }

    public static String getCurrentDate(DateStyle style) {
    ...
    /**
     * 获取 指定日期的结束时间（23:59:59）
     * @return
     */
    public static Date getSureDateCalendar(String date) {
        //告警
        DateFormat df = new SimpleDateFormat(datePattern);
        Calendar calendar = Calendar.getInstance();
        Date d = null;
    ...
    public static String getDateTimeStr(){
        return toString(TimeUtil.now(), MILLI_DATETIME_STR);
    }
