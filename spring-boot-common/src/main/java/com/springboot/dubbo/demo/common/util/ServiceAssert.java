...
import com.springboot.dubbo.demo.common.web.AppException;
import com.springboot.dubbo.demo.common.web.ResponseHeader;
import com.springboot.dubbo.demo.common.web.StandardResponseHeader;
...
public abstract class ServiceAssert {
	...
	public static void notNull(String desc,Object... objects){
		ResponseHeader header = ResponseHeader.newInstance(StandardResponseHeader.ERROR.getCode(),desc);
		notNull(header,objects);
	}
